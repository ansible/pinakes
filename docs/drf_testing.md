...
![Alt_ServiceOfferings](./docs/drf_images/service_offerings.png?raw=true)
...
![Alt_ServicePlans](./docs/drf_images/service_plan.png?raw=true)
...
7. Create a new order
     ...
     ![Alt_OrderCreated](./docs/drf_images/order_created.png?raw=true)
...
8. Add an order item to the order
    ...
    ![Alt_AddOrderItem](./docs/drf_images/add_an_order_item.png?raw=true)
9. Submit the order
...
![Alt_ProgressMessages](./docs/drf_images/progress_messages)
