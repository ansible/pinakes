...
from inventory.task_utils.service_offering_import import ServiceOfferingImport, OfferingKind
...
from inventory.models import ServiceInventory, ServiceOffering, ServicePlan
