...
class TestRefreshInventory:
    ...
    @patch(
        "automation_services_catalog.main.inventory.task_utils.refresh_inventory.ServiceOfferingNodeImport",
        autoSpec=True,
    )
    @patch(
        "automation_services_catalog.main.inventory.task_utils.refresh_inventory.ServiceInventoryImport",
        autoSpec=True,
    )
    @patch(
        "automation_services_catalog.main.inventory.task_utils.refresh_inventory.ServiceOfferingImport",
        autoSpec=True,
    )
