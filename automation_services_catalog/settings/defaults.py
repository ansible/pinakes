"""
Django settings for automation_services_catalog project.
...
INSTALLED_APPS = [
    ...
    "social_django",
    "corsheaders",
    "automation_services_catalog.main",
]
...
MIDDLEWARE = [
    ...
    "automation_services_catalog.common.auth.middleware.KeycloakAuthMiddleware",
]

ROOT_URLCONF = "automation_services_catalog.urls"
...
WSGI_APPLICATION = "automation_services_catalog.wsgi.application"
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "automation_services_catalog.common.exception_handler.custom_exception_handler",
}
