""" Production Settings
    defined in /etc/pinakes/settings.py or in
               /etc/pinakes/conf.d/settings.py
"""
import sys
import os
import traceback
...
# environment, defaulting to /etc/pinakes/settings.py.
settings_file = os.environ.get(
    "CATALOG_SETTINGS_FILE", "/etc/pinakes/settings.py"
)

# Attempt to load settings from /etc/pinakes/settings.py first, followed by
# /etc/pinakes/conf.d/*.py.
try:
