...
kubectl delete --namespace=catalog -f ./tools/minikube/templates/postgres-catalog-deployment.yaml
kubectl delete --namespace=catalog -f ./tools/minikube/templates/postgres-catalog-service.yaml
...
kubectl delete --namespace=catalog -f ./tools/minikube/templates/catalogpg-data-persistentvolumeclaim.yml
